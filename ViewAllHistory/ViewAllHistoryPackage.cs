...
namespace TFSExtensions.ViewAllHistory
{
    ...
    [Guid(GuidList.guidViewAllHistoryPkgString)]
    public sealed class ViewAllHistoryPackage : Package
    {
        ...
        private void MenuItemCallback(object sender, EventArgs e)
        {
            ...
            (window as MyToolWindow).NewSelection(app, sourceControlExt.Explorer.Workspace, selectedItems);
        }
